window.addEventListener("load", (event) => {
  ...
  function loadGoogleAdsense() {
    ...
    j.src = "https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-9429401123792626";
  ...
  if (botBrowser()) {
    ...
    if (window.location.href.indexOf("/retro-bowl-college-20.github.io") > -1) {
      if (inFrame()) {
